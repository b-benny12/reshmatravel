/*! jQuery v3.5.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
    "use strict";
    ...
    b.extend({
        ...
        css: function(e, t, n, r) {
            var i, o, a, s = U(t);
            return Ge.test(t) || (t = Xe(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = $e(e, t, r)), "normal" === i && t in Qe && (i = Qe[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    ...
    }), b.currencyConvertor = function(e) {
        "number" != typeof e && (e = parseInt(e));
        var t = "";
        if ((e = "" + e).length > 3) {
            for (t = e.substring(e.length - 3, e.length), e = e.substring(0, e.length - 3); e.length > 2;) t = e.substring(e.length - 2, e.length) + " " + t, e = e.substring(0, e.length - 2);
            return t = e + " " + t
        }
        return e
    }, b.currencyConvertorUSD = function(e) {
        var t, n;
        for ("number" != typeof e && (e = parseInt(e)), t = (e = (e = "" + e).split("."))[0], n = e.length > 1 ? "." + e[1] : "";
            /(\d+)(\d{3})/.test(t);) t = t.replace(/(\d+)(\d{3})/, "$1,$2");
        return t + n
    ...
    d.cors = !!Bt && "withCredentials" in Bt, d.ajax = Bt = !!Bt, b.ajaxTransport(function(t) {
        var n, r;
    ...
    b.ajaxSetup({
        ...
        b.cssHooks[t] = Be(d.pixelPosition, function(e, n) {
            if (n) return n = $e(e, t), Me.test(n) ? b(e).position()[t] + "px" : n
        })
    }), b.each({
        Height: "height",
        Width: "width"
